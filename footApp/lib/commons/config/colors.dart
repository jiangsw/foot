...
class Colours {
  ...
  static const Color qdailyMajorColor = Color(0xFFFFD003);
  static const Color qdailyMinorColor = Color(0xFFFFE48E);

  static const Color lineColor = Color(0xFFE6E6E6); //230

  static const Color appbarColor = Color(0xFF23ADE5);
}
